...
<body style="background:url(__PUBLIC__/image/bg_3.jpg) no-repeat;  background-color:#3D80AD;">
        ...
        <div class="panel panel-primary" id="login-panel">
            ...
            <div class="panel-body" style="">
                ...
                <input type="checkbox" value="remember-me">记住密码
                    ...
                    <button type="button" class="btn btn-default btn-lg btn-block" id="register" data-toggle="modal" data-target="#myModal">注 册</button>
    ...
    var verifyURL = "<?php echo U('Home/Index/verify/', '', '');?>";
    </script>
