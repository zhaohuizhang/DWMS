...
/** \file
* Internal functions of SamAV2_X implementation of Virtual Card Architecture (R) Application Component.
...
#ifndef PHALVCA_SAMAV2_X_INT_H
#define PHALVCA_SAMAV2_X_INT_H
