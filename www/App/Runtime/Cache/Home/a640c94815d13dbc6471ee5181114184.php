    ...
    <div class="container">
        <div class="panel panel-primary" id="login-panel" style="margin-top:20px">
            ...
            <div class="panel-body" style="">
                ...
                <form role="form" id="productionForm">
                        ...
                        <big>
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <tr>
                                    <td>产生单位编号</td>
                                    <td>
                                        <input type="text" class="form-control input-md required-cn number-cn" name="production_unit_id" id="production_unit_id">
                                    </td>
                                    <td>用户编号</td>
                                    <td>
                                        <input type="text" class="form-control input-md required-cn number-cn" name="user_id" id="user_id">
                                    </td>
                                </tr>
                                <tr>
                                    <td>产生单位名称</td>
                                ...
                                <tr>
                                    ...
                                    <td>产废设施所属区县</td>
                                    <td>
                                        <input type="text" class="form-control input-md required-cn" name="waste_location_county" id="waste_location_county">
                                    </td>
                                </tr>
                                <tr>
                                    <td>产废设施所在区县代码</td>
                                    ...
                                    <td>产生单位管辖权属</td>
                                    <td>
                                        <input type="text" class="form-control input-md required-cn" name="production_unit_jurisdiction" id="production_unit_jurisdiction">
                                    </td>
                                </tr>
                                <tr>
                                    <td>产生单位所属行业</td>
                                ...
                                <tr>
                                    <td>产生单位注册类型</td>
                                    <td>
                                        <input type="text" class="form-control input-md" name="production_unit_registration_type" id="production_unit_registration_type">
                                    </td>
                                    <td>产生单位企业规模</td>
                                    <td>
                                        <input type="text" class="form-control input-md" name="roduction_unit_enterprise_scale" id="roduction_unit_enterprise_scale">
                                    </td>
                                </tr>
                                <tr>
                                    <td>产生单位环保联系人姓名</td>
                                    ...
                                    <td>产生单位环保联系人电话</td>
                                    <td>
                                        <input type="text" class="form-control input-md required-cn" name="roduction_unit_contacts_phone" id="roduction_unit_contacts_phone">
                                    </td>
                                </tr>
                                <tr>
                                    <td>产生单位法人代码</td>
                                    ...
                                    <td>产生单位法人姓名</td>
                                    <td>
                                        <input type="text" class="form-control input-md required-cn" name="roduction_unit_legal_person_name" id="roduction_unit_legal_person_name">
                                    </td>
                                </tr>
                                <tr>
                                    <td>产生单位法人电话</td>
